...
const navigationMenuTriggerStyle = cva(
  'group/navigation-menu-trigger inline-flex justify-center items-center data-open:bg-muted/50 data-open:hover:bg-muted data-open:focus:bg-muted data-popup-open:bg-muted/50 data-popup-open:hover:bg-muted hover:bg-muted focus:bg-muted disabled:opacity-50 px-2.5 py-1.5 rounded-none outline-none focus-visible:outline-1 focus-visible:ring-1 focus-visible:ring-ring/50 w-max h-9 font-medium text-xs transition-all disabled:pointer-events-none',
);
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{' '}
      <ChevronDownIcon
        className="top-px relative ml-1 size-3 group-data-open/navigation-menu-trigger:rotate-180 group-data-popup-open/navigation-menu-trigger:rotate-180 transition duration-300"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        'data-[motion=from-end]:slide-in-from-right-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 group-data-[viewport=false]/navigation-menu:bg-popover data-[motion=from-start]:slide-in-from-left-52 data-ending-style:opacity-0 data-starting-style:opacity-0 group-data-[viewport=false]/navigation-menu:shadow p-1 group-data-[viewport=false]/navigation-menu:rounded-none **:data-[slot=navigation-menu-link]:focus:outline-none group-data-[viewport=false]/navigation-menu:ring-1 group-data-[viewport=false]/navigation-menu:ring-foreground/10 **:data-[slot=navigation-menu-link]:focus:ring-0 w-auto h-full group-data-[viewport=false]/navigation-menu:text-popover-foreground transition-[opacity,transform,translate] data-ending-style:data-activation-direction=left:translate-x-[50%] data-ending-style:data-activation-direction=right:translate-x-[-50%] data-starting-style:data-activation-direction=left:translate-x-[-50%] data-starting-style:data-activation-direction=right:translate-x-[50%] data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out group-data-[viewport=false]/navigation-menu:data-closed:animate-out group-data-[viewport=false]/navigation-menu:data-open:animate-in duration-[0.35s] group-data-[viewport=false]/navigation-menu:duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out group-data-[viewport=false]/navigation-menu:data-open:fade-in-0 group-data-[viewport=false]/navigation-menu:data-open:zoom-in-95 group-data-[viewport=false]/navigation-menu:data-closed:fade-out-0 group-data-[viewport=false]/navigation-menu:data-closed:zoom-out-95',
        className,
      )}
      {...props}
    />
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      {...props}
    >
      <div className="top-[60%] relative shadow-md bg-border rounded-none w-2 h-2 rotate-45" />
    </NavigationMenuPrimitive.Icon>
  );
}

const submenuContentClassName =
  'flex h-full translate-x-0 flex-col gap-4 p-4 min-[700px]:blur-0 transition-[opacity,translate,filter] duration-[var(--duration)] ease-[cubic-bezier(0.22,1,0.36,1)] min-[700px]:duration-[calc(0.35s*0.5)] min-[700px]:ease-[cubic-bezier(0.16,1,0.3,1)] ' +
