  ...
  return (
    <div className="right-6 bottom-6 z-50 fixed flex flex-col-reverse items-end gap-4">
      ...
      >
        ...
        <Link
          href="tel:0904683035"
          className="flex items-center gap-2 bg-primary shadow-lg hover:shadow-xl px-5 py-3 rounded-full text-primary-foreground transition-transform hover:-translate-y-1"
        >
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="flex justify-center items-center bg-[#0068FF] shadow-lg hover:shadow-xl rounded-full w-14 h-14 text-white transition-transform hover:-translate-y-1"
          title="Nhắn Zalo"
        >
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="flex justify-center items-center bg-[#0866FF] shadow-lg hover:shadow-xl rounded-full w-14 h-14 text-white transition-transform hover:-translate-y-1"
